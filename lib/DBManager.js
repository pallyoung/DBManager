/*DBManager.js*/
/*
把promise规范加入到dbm中，所有的方法调用都采用链式去调用,所有的调用都在一个promise里面执行
问题就解决啦，妥妥的啊--
妥你妈蛋啊 搞不定啊！！！！！！
...
(function(window, undefined) {
	...
	DBM.prototype.put = function(objectStore, data) {
		...
		this.then(function() {
			business.call(self, objectStore, data);
		});

		function business(objectStore, data) {
	...
	DBM.prototype.query = function(objectStore,indexName,keys, keyRange,direction) {
		...
		this.then(function() {
			business.call(self, objectStore,indexName,keys, keyRange,direction);
		});

		function business(objectStore,indexName,keys,keyRange, direction) {
	...
	DBM.prototype.del = function(objectStore, keys) {
		var self = this;
		this.then(function() {
			business(objectStore, keys)
		});

		function business(objectStore, keys) {
	...
	DBM.prototype.deleteObjectStore = function(objectStore) {
		...
		function promiseCB() {
			changeVersion.call(self, handle);
		}
		return this;
	};
	...
	DBM.prototype.contains = function(objectStore) {
		...
		this.then(function() {
			business.call(self, objectStore);
		}, noop);
		return this;
	};
	DBM.prototype.deleteIndex = function(objectStore, indexNames) {
		...
		function promiseCB() {
			changeVersion.call(self, business);
		}
		return this;
	};
